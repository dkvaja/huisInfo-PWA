                        ...
                        <Grid item container spacing={2} xs={12} md={7} className={classes.container}>
                            ...
                            <Grid item xs={12}>
                                <Typography align="center" paragraph>
                                    Uw kopersbegeleider zal de getekende offerte en bijlage(n) controleren.
                                    </Typography>
                            </Grid>
                            <Grid item xs={12}>
                            ...
                            <Grid item container justify="center" xs={12}>
                                <Button component={Link} to="/home" variant="contained" color="primary" className={classes.button}>{t('Optie statusoverzicht')}</Button>
                            </Grid>
                        </Grid>
                    </Grid>
                </Container>
