...
{
    public class ViewPortalGebouwKoperHuurderConfiguration : IEntityTypeConfiguration<ViewPortalGebouwKoperHuurder>
    {
        public void Configure(EntityTypeBuilder<ViewPortalGebouwKoperHuurder> builder)
        {
            builder.HasNoKey();

            builder.ToView("view_portal_gebouw_koper_huurder");
            ...
            builder.Property(e => e.RelatieGuid).HasColumnName("relatie_guid");
