...
{
    public class ViewPortalOptieStandaardPerWerkConfiguration : IEntityTypeConfiguration<ViewPortalOptieStandaardPerWerk>
    {
        public void Configure(EntityTypeBuilder<ViewPortalOptieStandaardPerWerk> builder)
        {
            builder.HasNoKey();

            builder.ToView("view_portal_optie_standaard_per_werk");

            builder.Property(e => e.Aantal)
                .HasColumnName("aantal")
                .HasColumnType("numeric(10, 2)");

            builder.Property(e => e.AantalBijlagen).HasColumnName("aantal_bijlagen");
